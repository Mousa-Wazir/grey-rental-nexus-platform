      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center text-white max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link to="/auth">
              <Button className="localena-yellow text-black font-semibold px-8 py-4 -mx-0 text-sm">
                Get Started
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link to="/nadra-verification">
              <Button className="bg-white text-black hover:bg-gray-50 font-semibold text-xs py-[20px] gap-y-px text-center">
